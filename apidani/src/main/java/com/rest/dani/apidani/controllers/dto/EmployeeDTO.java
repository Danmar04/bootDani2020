package com.rest.dani.apidani.controllers.dto;
...
public class EmployeeDTO {
    ...
    @Min(value = 0, message = "You can't be in doubt with the Universe")
    ...
    public EmployeeDTO(String name, String surname, String password, Integer age, Double dolars, String rol, List<String> knowledge) {
        this.name = name;
